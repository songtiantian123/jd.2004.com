...
<head>
    ...
    <script>
        $(document).ready(function(){
            // 全部/全选
            $(document).on("click",".goods_all",function () {
               var _this = $(this);
               // 商品数量
            ...
            $(document).on("click",".shops",function(){
                ...
                _this.parent(".cart-shop").next(".cart-body").find(":checkbox").prop("checked",_this.prop('checked'));
            })
            ...
            $(document).on("click",".increment",function () {
                ...
                var price = parseFloat(_this.parents(".yui3-u-1-8").prev("").find(".price").text());
		...
		<div class="py-container">
			...
			@if(empty(session('uid')))
				<ul class="fl">
					...
					<li class="f-item">请<a href="{{'/user/login'}}" {{session('user_name')}} target="_blank">登录</a>
					<span><a href="{{'user/register'}}">免费注册</a></span></li>
					@endif
				</ul>
				<ul class="fr">
		...
		<div class="allgoods">
			...
			<div class="cart-main">
				<div class="yui3-g cart-th">
					<div class="yui3-u-1-4"><input type="checkbox" class="goods_all" name="" id="" value="" /> 全部</div>
				...
				<div class="cart-item-list">
					<div class="cart-shop">
						<input type="checkbox" name="" class="shops" id="" value="" />
						<span class="shopname self">{{$v['cat_name']}}</span>
					</div>
					<div class="cart-body">
						...
						<div class="cart-list">
							<ul class="goods-list yui3-g">
								...
								<li class="yui3-u-1-24">
									<input type="checkbox" name="user_name[]" class="goods_child" id="" value="{{$val['goods_id']}}" />
								</li>
								<li class="yui3-u-11-24">
									<div class="good-item">
										<div id="cc" class="item-img"><img src="/static/index/img/goods.png"?/></div>
										<div class="item-msg">{{$val['goods_name']}}</div>
									</div>
								</li>
								<li class="yui3-u-1-8"><span class="price">{{$val['shop_price']}}</span></li>
								<li class="yui3-u-1-8">
									<a href="javascript:void(0)" class="increment mins">-</a>
									<input autocomplete="off" type="text" value="1" minnum="1" class="itxt" />
									<a href="javascript:void(0)" class="increment plus">+</a>
								</li>
								<li class="yui3-u-1-8"><span class="sum">{{$val['shop_price']}}</span></li>
								<li class="yui3-u-1-8">
									<a href="#none">删除</a><br />
			...
			<div class="cart-tool">
				<div class="select-all">
					<input type="checkbox" name="" class="goods_all" id="" value="" />
					<span>全选</span>
				</div>
				<div class="option">
				...
				<div class="toolbar">
					...
					<div class="sumprice">
						<span><em>总价（不含运费） ：</em>￥<i class="summoney">0</i></span><br>
					...
					<div class="sumbtn">
						...
						<a class="sum-btn" href="{{url('/cart/getOrderInfo')}}?goods_id={{$val['goods_id']}}" target="_blank">生成订单</a>
					</div>
				</div>
			</div>
