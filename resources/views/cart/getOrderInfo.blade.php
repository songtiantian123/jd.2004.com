...
<body>
	...
	<div class="cart py-container">
						...
						<ul class="addr-detail">
							<li class="addr-item">
							  ...
							  <div>
								...
								<div class="con address">张默 北京市海淀区三环内 中关村软件园9号楼
                                    <span>159****3201</span>
							  ...
							  <div>
								<div class="con name">
                                    <a href="javascript:;">李煜<span title="点击取消选择">&nbsp;</a></div>
								<div class="con address">李煜 北京市海淀区三环内 中关村软件园8号楼
                                    <span>187****4201</span>
								<span class="edittext">
                                    <a data-toggle="modal" data-target=".edit" data-keyboard="false" >编辑</a>&nbsp;&nbsp;
							  ...
							  <div>
								<div class="con name">
                                    <a href="javascript:;">王希<span title="点击取消选择">&nbsp;</a>
                                </div>
								<div class="con address">王希 北京市海淀区三环内 中关村软件园6号楼
                                    <span>156****5681</span>
								<span class="edittext">
                                    <a data-toggle="modal" data-target=".edit" data-keyboard="false" >编辑</a>&nbsp;&nbsp;
                                    <a href="javascript:;">删除</a>
				...
				<div class="payshipInfo">
					...
					<div class="step-cont">
						<ul class="payType">
                            ...
                            <li class="">支付宝付款<span title="点击取消选择"></span></li>
							...
							<li>
								...
								<div class="sendGoods">
									...
									<ul class="yui3-g">
										...
										<li class="yui3-u-1-6">
											<span><img src="/static/index/img/goods.png"/></span>
										</li>
		...
		<div class="submit">
			<a class="sui-btn btn-danger btn-xlarge" href="/orders/pay">提交订单</a>
		</div>
	</div>
	<!-- 底部栏位 -->
	<!--页面底部-->
