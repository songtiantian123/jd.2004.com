			...
			<div class="py-container">
				<div class="shortcut">
					<ul class="fl">
						...
						<li class="f-item">请<a href="{{url('user/login')}}" target="_blank">登录</a>
...
<script type="text/javascript" src="/static/index/js/pages/seckill-index.js"></script>
<script type="text/javascript" src="/static/index/js/pages/shop.js"></script>
<script>
	   $(function(){
		   $("#code").hover(function(){
			   $(".erweima").show();
    ...
    <div class="py-container shop">
        ...
        <div class="shop-logo">
            <div class="fl logo-img">
                <img src="/static/index/img/_/shop-logo.png" />
            </div>
            <div class="shop-vip">
                <div class="pay">
                    <img src="/static/index/img/_/car.png" alt="">
                    <span>
                         全场免运费<br />
                         货到付款
                    </span>
            ...
            <div class="sui-navbar">
                <div class="navbar-inner">
                    ...
                    <form class="sui-form sui-form pull-right">
                        <input type="text" value="" name="goods_name"   placeholder="连衣裙...">
                ...
                <div id="tab-one" class="tab-pane active">
                    <ul class="yui3-g" id="tab-list">
                        ...
                        <li class="yui3-u-1-4">
                            <div class="list-wrap" >
                                <div class="p-img">
                                    <a href="{{url('goods/details')}}?id={{$v['goods_id']}}">
                                        <img src="/upload/images/u=3716030085,4038629400&fm=26&gp=0.jpg" alt=''>
                                    </a>
                                </div>
                                <div class="price">
                                    <strong><em>¥</em>
                                ...
                                <div class='cu'><em>
                                        <span>促</span>{{$v['keywords']}}
                                    </em>
                                </div>
                                <div class="operate">
                                    <a href="{{url('cart/cart')}}?goods_id={{$v['goods_id']}}" target="_blank" class="sui-btn btn-bordered btn-danger">加入购物车</a>
