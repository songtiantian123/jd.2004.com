	...
	<div class="login-box">
		...
		<div class="loginArea">
				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" action="{{url('user/loginDo')}}" method="post">
                                @csrf
          ...
          自动登录
								...
								<div class="logined">
									<input type="submit" value="登 录" class="sui-btn btn-block btn-xlarge btn-danger" href="home-index.html" >
								</div>
							</form>
							<div class="otherlogin">
								<div class="types">
									<ul>
										...
										<li><a href="https://github.com/login/oauth/authorize?client_id=91e03f1a46ed1af147b2">GitHub</a></li>
									</ul>
								</div>
								<span class="register"><a href="{{url('user/register')}}" target="_blank">立即注册</a></span>
							</div>
						</div>
					</div>
				</div>
