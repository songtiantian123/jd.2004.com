...
<body>
	<div class="register py-container ">
		...
		<div class="registerArea">
			<h3>注册新用户<span class="go">我有账号，去<a href="{{url('user/login')}}" target="_blank">登陆</a></span></h3>
			<div class="info">
				<form class="sui-form form-horizontal" action="{{url('user/registerDo')}}" method="post">
                    @csrf
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" placeholder="请输入你的用户名" name="email" class="input-xfat input-xlarge">
                        </div>
                    </div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="password" placeholder="再次确认密码" name="confirm" class="input-xfat input-xlarge">
						</div>
					</div>
<!--
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" placeholder="短信验证码" name="sendEmail" class="input-xfat input-xlarge">
                            <a href="#">获取短信验证码</a>
						</div>
					</div>-->
					...
					<div class="control-group">
						...
						<div class="controls btn-reg">
							<input class="sui-btn btn-block btn-xlarge btn-danger" type="submit" href="{{url('user/registerDo')}}" target="_blank" value="完成注册">
						</div>
					</div>
				</form>
