            ...
            <div class="yui3-u-1-6 list">
                ...
                <div class="person-info">
                    ...
                    <div class="person-account">
                        ...
                        <span class="safe">账户安全
                            <a href="{{url('index/sign')}}">签到</a>
                        </span>
                    </div>
                ...
                <div class="list-items">
                    ...
                    <dl>
                        <dt><i>·</i> 我的中心</dt>
                        <dd><a href="{{url('index/collect')}}" class="list-active">我的收藏</a></dd>
                        <dd><a href="home-person-footmark.html">我的足迹</a></dd>
                        <dd><a href="{{url('/coupon')}}">优惠卷</a></dd>
{{--                        <dd><a href="{{url('index/sign')}}">今日签到</a></dd>--}}
                    </dl>
                    <dl>
                        <dt><i>·</i> 物流消息</dt>
                    </dl>
   ...
   <!--右侧主内容-->
            <form action="/coupon/receive" method="post" id="btn-coupon" >
                @foreach($CouponInfo as $k=>$v)
                    @if([$v['coupon_name']=='满减卷'])
                        <div class="yui3-u-5-6 goods" >
                            <input  type="radio" name="coupon_id" value="{{$v['coupon_id']}}">
                                {{$v['coupon_name']}}
                                满 {{$v['increase']}}
                                减 {{$v['reduce']}}
                        </div>
...
<script>
    $(document).ready(function () {
        $(document).on("submit","btn-coupon",function () {
              var _radio = $(":radio");
              _sub =false;
