			...
			<div class="py-container">
				<div class="shortcut">
					<ul class="fl">
						...
						<li class="f-item">
                            请<a href="{{url('/user/login')}}"  target="_blank">登录</a>　
                            <span>
                                <a href="{{url('/user/register')}}" target="_blank">免费注册</a>
                            </span>
                        </li>
                        @else
                            <li class="f-item">欢迎<a href="{{url('home')}}">{{session('user_name')}}</a>登录
                           &nbsp&nbsp&nbsp&nbsp <li class="f-item"><a href="{{url('user/exit')}}" onclick="return confirm('确定要退出吗？')">退出</a></li>
					    @endif
					...
					<ul class="fr">
						...
						<li class="f-item"><a href="{{url('index/center')}}" target="_blank">我的品优购</a></li>
						<li class="f-item space"></li>
						...
						<div class="search">
							<form action="" class="sui-form form-inline">
								...
								<div class="input-append">
									<input type="text" placeholder="请输入关键字" value="" id="autocomplete" name="goods_name"  type="text" class="input-error input-xxlarge" />
...
{{--                                <li class="f-item">亿元优惠</li>--}}
                                <li class="f-item"><a href="/coupon">优惠卷</a></li>
								<li class="f-item">9.9元团购</li>
				...
				<div class="yui3-g NavList">
					...
					<div class="yui3-u Center navArea">
						<ul class="nav">
                            ...
                            <li class="f-item"><a href="/prize">抽奖</a></li>
				...
				<div class="yui3-u Right">
					...
					<ul class="yui3-g Lifeservice">
						...
						<li class="yui3-u-1-4 life-item tab-item">
							...
							<span class="service-intro"><a href="/film?film_id=1">电影票</a></span>
						</li>
						<li class="yui3-u-1-4 life-item tab-item">
					...
					<div class="life-item-content">
						...
						<div class="life-detail">
							<i class="close">关闭</i>
                            <p>电影票</p>
                            <a href="/film?film_id=1">立即购买电影票</a>
						</div>
						<div class="life-detail">
		...
		<div class="py-container">
			<ul class="yui3-g Recommend">
				...
				<li class="yui3-u-5-24">
					<a href="{{url('goods/list')}}" target="_blank"><img src="/static/index/img/today01.png" /></a>
				</li>
                @endforeach
			</ul>
		</div>
				...
				@foreach($random as $k=>$v)
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="{{url('/goods/details')}}?id={{$v[0]['goods_id']}}" class="pic">
								   <img src="/static/index/img/like_02.png" alt="" />
								</a>
								<div class="like-text">
									<p>{{$v[0]['goods_name']}}</p>
									<h3>{{$v[0]['shop_price']}}</h3>
								</div>
							</dd>
					</li>
					@endforeach
